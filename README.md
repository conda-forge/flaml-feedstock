...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/flaml-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14143&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/flaml-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `flaml` can be installed with:

```
conda install flaml
```

It is possible to list all of the versions of `flaml` available on your platform with:
...
* [@Shao-kun-Zhang](https://github.com/Shao-kun-Zhang/)
